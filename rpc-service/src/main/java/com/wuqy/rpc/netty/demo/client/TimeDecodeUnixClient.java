...
import com.wuqy.rpc.netty.demo.clienthandler.TimeUnixClientHandler;
import com.wuqy.rpc.netty.demo.decode.TimeDecoderUnix;
 ...
 */
public class TimeDecodeUnixClient {
    ...
    public static void main(String[] args) throws Exception {
        String host = TimeDecodeUnixClient.host;
        int port = TimeDecodeUnixClient.port;
        ...
        try {
            ...
            b.handler(new ChannelInitializer<SocketChannel>() {
                ...
                public void initChannel(SocketChannel ch) throws Exception {
                    ch.pipeline().addLast(new TimeDecoderUnix(), new TimeUnixClientHandler());
                }
            });
