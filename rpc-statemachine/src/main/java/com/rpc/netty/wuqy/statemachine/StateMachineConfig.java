package com.rpc.netty.wuqy.statemachine;
...
/**
 * https://blog.csdn.net/m0_37138008/article/details/74858122
 * 创建状态机配置类
    ...
    public StateMachineListener<States, Events> listener() {
        return new StateMachineListenerAdapter<States, Events>() {
            ...
            public void transition(Transition<States, Events> transition) {
                logger.info("============in:"+(transition.getSource() != null?transition.getSource().getStates().toString():"")+","+transition.getTarget().getStates().toString());
                ...
                logger.info("状态非法:"+transition.getSource().getStates().toString()+","+transition.getTarget().getStates().toString());
            }
